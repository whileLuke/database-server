...
//import java.util.*;
//
//public class TableBeta {
//    private static final String FILE_EXTENSION = ".tab";
//    private List<String> columns;
//    private List<List<String>> rows;
//
//    public TableBeta(List<String> columns) {
...
//            throw new IllegalArgumentException("Row size does not match the table's column count.");
//        }
//        rows.add(newRow);
//    }
//
//    // Returns the index of a column based on its name
//    public int getColumnIndex(String columnName) {
//        return columns.indexOf(columnName);
//    }
//
//    // Select rows that match the given conditions
//    public List<List<String>> selectRowsWithConditions(List<String> conditions) {
...
//    }
//
//    // Select specific columns (can include conditions)
//    public List<List<String>> selectColumns(List<String> selectedColumns, List<String> conditions) {
//        List<List<String>> result = new ArrayList<>();
...
//        }
//
//        // Go through each row, applying the conditions and extracting the selected columns
//        for (List<String> row : rows) {
//            if (matchesConditions(row, conditions)) {
...
//    }
//
//    // Updates rows that match the given conditions with new values
//    public void updateRows(List<String> conditions, List<String> newValues) {
//        for (List<String> row : rows) {
//            if (matchesConditions(row, conditions)) {
//                for (int i = 0; i < newValues.size(); i++) {
//                    row.set(i, newValues.get(i));
//                }
//            }
//        }
//    }
...
//    public void deleteRowsWithConditions(List<String> conditions) {
...
//    public static TableBeta loadFromFile(String directoryPath, String tableName) {
//        String filePath = directoryPath + File.separator + tableName + ".tab";
...
//
//                    // If it's the first line, it's the column names
//                    if (firstLine) {
//                        columnNames = Arrays.asList(values);
//                        TableBeta table = new TableBeta(columnNames);
//                        firstLine = false;
//                    } else {
//                        // Otherwise, it's a row of data
//                        List<String> row = new ArrayList<>(Arrays.asList(values));
//                        // Create a new Table with column names and add the row to it
//                        table.addRow(row);
//                    }
//                }
//
...
//        }
//
//        return null;  // Return null if the table file doesn't exist or can't be loaded
//    }
//
//
...
//            if (columnIndex == -1 || !row.get(columnIndex).equals(value)) {
//                return false;
//            }
//        }
//        return true;
...
//        }
//
//        rows.sort(Comparator.comparing(row -> row.get(columnIndex)));
//    }
//
...
//    }
//
//    // Check if a row exists by matching a condition
//    public boolean rowExists(List<String> conditions) {
//        return rows.stream().anyMatch(row -> matchesConditions(row, conditions));
//    }
//
...
//            if (!seen.add(row.get(columnIndex))) {
//                iterator.remove();
//            }
//        }
//    }
...
//    }
//
//    // Get the columns as a list of strings
